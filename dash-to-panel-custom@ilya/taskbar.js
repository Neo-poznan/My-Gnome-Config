...
var Taskbar = class Taskbar {
    ...
    enable(panel) {
        ...
        // Добавляем элементы в нужные позиции
        ...
        this._settingsChangedId = this._settings.connect('changed', (settings, key) => {
            if (key === 'showapps-position' || key === 'taskbar-position' ||
                key === 'hide-showapps' || key === 'hide-taskbar' ||
                key === 'showapps-priority' || key === 'taskbar-priority') {
                this._updatePositions();
